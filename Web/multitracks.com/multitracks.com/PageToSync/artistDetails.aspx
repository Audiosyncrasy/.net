	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form>
			...
			<div class="wrapper mod-standard mod-gray">
                <asp:Repeater runat="server" ID="artistDetails">
                    <ItemTemplate>
				...
				<div class="discovery--container u-container">
							<main class="discovery--section">
                                                    ...
                                                    <ItemTemplate>
												        <div class="media-item">
													        <a class="media-item--img--link" href="#" tabindex="0">
														        <img class="media-item--img" alt="<%#Eval("albumtitle") %>" src="<%#Eval("imageURL") %>" srcset="<%#Eval("imageURL") %>, <%#Eval("imageURL") %> 2x">
								...
								<section class="standard--holder">
                                    ...
                                    <asp:Repeater runat="server" ID="artistBio">
                                        <ItemTemplate>
